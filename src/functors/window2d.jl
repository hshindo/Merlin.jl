export window2d, Window2D

const WINDOW2D_FWD_F32_HANDLE = Libdl.dlsym(library, :window_fwd_f32)
const WINDOW2D_BWD_F32_HANDLE = Libdl.dlsym(library, :window_bwd_f32)
const WINDOW2D_FWD_F64_HANDLE = Libdl.dlsym(library, :window_fwd_f64)
const WINDOW2D_BWD_F64_HANDLE = Libdl.dlsym(library, :window_bwd_f64)
