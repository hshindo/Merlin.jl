# Julia wrapper for header: /home/shindo/local-lemon/cuda-8.0/include/curand.h
...
function curandGetProperty(_type,value)
    check_curandstatus(ccall((:curandGetProperty,libcurand),curandStatus_t,(libraryPropertyType,Ptr{Cint}),_type,value))
end
...
function curandGenerateBinomial(generator,outputPtr,num,n,p)
    check_curandstatus(ccall((:curandGenerateBinomial,libcurand),curandStatus_t,(curandGenerator_t,Ptr{UInt32},Csize_t,UInt32,Cdouble),generator,outputPtr,num,n,p))
end

function curandGenerateBinomialMethod(generator,outputPtr,num,n,p,method)
    check_curandstatus(ccall((:curandGenerateBinomialMethod,libcurand),curandStatus_t,(curandGenerator_t,Ptr{UInt32},Csize_t,UInt32,Cdouble,curandMethod_t),generator,outputPtr,num,n,p,method))
end
